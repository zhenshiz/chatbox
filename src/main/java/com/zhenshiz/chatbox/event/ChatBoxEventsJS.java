...
public interface ChatBoxEventsJS {
    ...
    EventHandler CHAT_BOX_RENDER_PRE = GROUP.client("renderPre", () -> ChatBoxRenderJS.Pre.class).hasResult();
    EventHandler CHAT_BOX_RENDER_POST = GROUP.client("renderPost", () -> ChatBoxRenderJS.Post.class);
