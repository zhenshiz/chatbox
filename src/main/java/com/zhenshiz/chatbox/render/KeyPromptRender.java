    ...
    public void render(GuiGraphics guiGraphics, float pPartialTick) {
        if (this.visible) {
            RenderUtil.renderOpacity(guiGraphics, this.opacity, () -> {
                ...
                //right scroll
                RenderUtil.renderImage(guiGraphics, BeanUtil.getValueOrDefault(this.rightClickTexture, ResourceLocation.parse("chatbox:textures/key/right_mouse.png")), x, y + 2, 0, this.mouseTextureWidth, this.mouseTextureHeight, 1);
                ...
                //mouse scroll
                RenderUtil.renderImage(guiGraphics, BeanUtil.getValueOrDefault(this.scrollTexture, ResourceLocation.parse("chatbox:textures/key/scroll_mouse.png")), x, y + 2, 0, this.mouseTextureWidth, this.mouseTextureHeight, 1);
