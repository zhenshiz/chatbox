    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float pPartialTick) {
        if (this.visible) {
            RenderUtil.renderOpacity(guiGraphics, 100, this.opacity, () -> {
                ...
                //right scroll
                RenderUtil.renderImage(guiGraphics, BeanUtil.getValueOrDefault(this.rightClickTexture, ResourceLocation.parse("chatbox:textures/key/right_mouse.png")), x, y + 2, mouseTextureWidth, mouseTextureHeight, 1, 0f);
                ...
                //mouse scroll
                RenderUtil.renderImage(guiGraphics, BeanUtil.getValueOrDefault(this.scrollTexture, ResourceLocation.parse("chatbox:textures/key/scroll_mouse.png")), x, y + 2, mouseTextureWidth, mouseTextureHeight, 1, 0f);
