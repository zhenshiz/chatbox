    ...
    public static class HistoricalInfo {
        ...
        public void click() {
            if (minecraft.player != null) {
                ...
                ChatBoxUtil.historicalDialogue.put(minecraft.player.getUUID(), new HistoricalDialogueScreen());
                ChatBoxUtil.skipDialogues(minecraft.player.getUUID(), resourceLocation, group, index);
            }
        }
