...
public interface PluginHelper {
    ...
    static void init() {
        addHandlerC2S(RESOLVE_PAPI, (player, s) -> {
            ...
            ChatBoxCommandUtil.serverSetDialogBox(player, name, text);
        });
        addHandlerS2C(SET_PAPI_LOADED, s -> DialogBox.papiLoaded = Boolean.parseBoolean(s));
    }
