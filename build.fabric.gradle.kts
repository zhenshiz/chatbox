...
dependencies {
    ...
    var loaderVersion = "${property("deps.fabric-loader")}"
    if (mcVersion == "1.21" || mcVersion == "1.20.1") loaderVersion = "0.15.11"
...
tasks {
    processResources {
        exclude("META-INF/neoforge.mods.toml", "META-INF/mods.toml",
            "META-INF/accesstransformer.cfg", "kubejs.plugins.txt")
    }
