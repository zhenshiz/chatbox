...
public class ChatOption extends Portrait<ChatOption> {
    //默认材质
    public static final Identifier root = ChatBox.id("textures/options/default_no_checked_option.png");
    //鼠标悬浮材质
    public static final Identifier hover = ChatBox.id("textures/options/default_checked_option.png");
    //上锁材质
    public static final Identifier lock = ChatBox.id("textures/options/default_lock_checked_option.png");
    //选项文本
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float pPartialTick) {
        ...
        if (!this.optionTooltip.isEmpty() && isSelect) {
            RenderUtil.renderTooltip(guiGraphics, Component.nullToEmpty(this.optionTooltip), (int) realX(), (int) realY());
        }
    }
}
